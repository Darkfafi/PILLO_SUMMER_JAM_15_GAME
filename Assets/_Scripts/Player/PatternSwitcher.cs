...
public class PatternSwitcher : MonoBehaviour {
	...
	void Update () {
		ShowPattern (_currentPatternName,(int)(patternBody.GetComponent<SpriteRenderer>().bounds.size.x * 87),(int)(patternBody.GetComponent<SpriteRenderer>().bounds.size.y * 88));
	}
